...
#define SERVER_IP "fe80::a6bb:6dff:fe44:fc43"
#define CLIENT_IP "fe80::a6bb:6dff:fe44:ddb8"

int main(int argc, char *argv[]) {
    if (argc != 4) {
        printf("Usage: %s server_ip server_port client_ip\n", argv[0]);
    ...
    // server_address.sin6_addr = inet_addr(server_ip);



    // Append "%eth0" to the IPv6 address
    char ip_address[INET6_ADDRSTRLEN]; // +5 for possible "%eth0"
    ...
    char client_ip[INET6_ADDRSTRLEN + 5];
    get_ip(client_ip);
